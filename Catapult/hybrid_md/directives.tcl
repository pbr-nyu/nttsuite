...
ignore_memory_precedences -from S5_OUTER_LOOP:for:for:write_mem(xx:rsc(*)(*).@)* -to S5_OUTER_LOOP:for:for:write_mem(xx:rsc(*)(*).@)*
ignore_memory_precedences -from S34_OUTER_LOOP:for:write_mem(xx:rsc(*)(*).@)* -to S34_OUTER_LOOP:for:write_mem(xx:rsc(*)(*).@)*
